function features = extract_file_features(data_file)
% data_file = "D:\Documents\14self\wireless-recognition\gait-WiDar\Gait_Dataset\CSI_Gait\user1-20190627\user1-1-44-r3.dat";
